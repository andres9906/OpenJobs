...
function Trabajo (props){
  const {history}=props; 
    ...
    return(
        ...
        <ListGroup.Item style={{width:'800px',height:'200px'}}><h4>Titulo</h4><br/><p>	
...
<div class="but" style={{paddingLeft:'650px',paddingTop:'10px'}}><Button variant="outline-info" onClick={() =>history.push('/Search/Detail')}>Ver mas</Button>
</div>
</ListGroup.Item>
<ListGroup.Item style={{width:'800px',height:'200px'}}><h4>Titulo</h4><br/><p>	
A unique identifier for the Component, the eventKey makes it distinguishable from others in a set. Similar to React's key prop, in that it only needs to be unique amongst the Components siblings, not globally.<br/></p>
<div class="but" style={{paddingLeft:'650px',paddingTop:'10px'}}><Button variant="outline-info">Ver mas</Button>
</div>
</ListGroup.Item>
